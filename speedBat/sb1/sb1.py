...
def trainBuffer(exp):
    ...
    if exp == 1:
        ...
        txt1= visual.TextStim(
            win = win,
            text = "In this task, we are going to show you two grids. Like the following:",
            pos = (0,150),
            color = [0,1,0]
        )
    ...
    if exp == 2:
        ...
        txt1= visual.TextStim(
            win = win,
            text = "In this task, we are going to show you a list of letters. Like the following:",
            pos = (0,250),
            color = [0,1,0]
        )
    ...
    txt6 =visual.TextStim(
        win = win,
        text = "If you have any questions, please call the RA over. \nPress 'X' to begin the task.",
        pos = (0,100),
        color = [0,1,0]
    )
    frame.append(txt6)
